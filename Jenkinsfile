...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 925134655474.dkr.ecr.us-east-1.amazonaws.com
	 docker build -t 925134655474.dkr.ecr.us-east-1.amazonaws.com/sandeep:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 925134655474.dkr.ecr.us-east-1.amazonaws.com/sandeep:SAMPLE-PROJECT-${BUILD_NUMBER}
